package com.ilkinmehdiyev.java17;

import com.ilkinmehdiyev.java17.model.Product;
import com.ilkinmehdiyev.java17.repository.ProductRepository;
...
public class BenchmarkTest {
  ...
  @Setup(Level.Trial)
  public void init() {
    context = SpringApplication.run(Java17Application.class);
  ...
  public static void main(String[] args) throws RunnerException {
    Options opts =
        new OptionsBuilder()
            ...
            .result("benchmark-result/java17/" + System.currentTimeMillis() + ".csv")
            .build();
    new Runner(opts).run();
  }
}
