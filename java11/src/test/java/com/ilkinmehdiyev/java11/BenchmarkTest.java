package com.ilkinmehdiyev.java11;

import com.ilkinmehdiyev.java11.model.Product;
import com.ilkinmehdiyev.java11.repository.ProductRepository;
...
public class BenchmarkTest {
  ...
  @Setup(Level.Trial)
  public void init() {
    context = SpringApplication.run(Java11Application.class);
  ...
  public static void main(String[] args) throws RunnerException {
    Options opts =
        new OptionsBuilder()
            ...
            .result("benchmark-result/java11/" + System.currentTimeMillis() + ".csv")
            .build();
    new Runner(opts).run();
  }
}
